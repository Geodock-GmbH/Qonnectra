import type { CableData, Waypoint } from '$lib/classes/NetworkSchemaState.svelte';
 ...
 */
export const saveCableGeometry = command(
	SaveGeometrySchema,
	async ({ cableId, diagramPath }: { cableId: string; diagramPath: Waypoint[] }) => {
