...
describe('+page.server.js', () => {
	...
	describe('saveNodeGeometry action', () => {
		test('should successfully save node geometry', async () => {
			...
			expect((result.node as Record<string, unknown>).uuid).toBe('test-node-123');
			expect((result.node as Record<string, unknown>).canvas_x).toBe(150.5);
			expect((result.node as Record<string, unknown>).canvas_y).toBe(200.3);
		...
		test('should successfully save child canvas coordinates', async () => {
			...
			expect(result.type).toBe('success');
			expect(result.message).toBe('Node position saved successfully');
			expect((result.node as Record<string, unknown>).child_canvas_x).toBe(150.5);
			expect((result.node as Record<string, unknown>).child_canvas_y).toBe(200.3);
	...
	describe('saveCableGeometry action', () => {
		test('should successfully save cable geometry', async () => {
			...
			const result = (await actions.saveCableGeometry({
				request: mockRequest,
				fetch: mockFetch,
				cookies: mockCookies
			} as Record<string, unknown>)) as Record<string, unknown>;
			...
			expect((result.cable as Record<string, unknown>).uuid).toBe('cable-123');
	...
	describe('updateCable action', () => {
		test('should successfully update a cable', async () => {
			...
			const result = (await actions.updateCable({
				request: mockRequest,
				fetch: mockFetch,
				cookies: mockCookies
			} as Record<string, unknown>)) as Record<string, unknown>;
	...
	describe('deleteCable action', () => {
		test('should successfully delete a cable', async () => {
			...
			const result = (await actions.deleteCable({
				request: mockRequest,
				fetch: mockFetch,
				cookies: mockCookies
			} as Record<string, unknown>)) as Record<string, unknown>;
	...
	describe('getNodes action', () => {
		test('should successfully fetch a node by uuid', async () => {
			...
			const result = (await actions.getNodes({
				request: mockRequest,
				fetch: mockFetch,
				cookies: mockCookies
			} as Record<string, unknown>)) as Record<string, unknown>;
	...
	describe('updateNode action', () => {
		test('should successfully update a node', async () => {
			...
			const result = (await actions.updateNode({
				request: mockRequest,
				fetch: mockFetch,
				cookies: mockCookies
			} as Record<string, unknown>)) as Record<string, unknown>;
			...
			expect((result.node as Record<string, unknown>).uuid).toBe('node-123');
	...
	describe('deleteNode action', () => {
		test('should successfully delete a node', async () => {
			...
			const result = (await actions.deleteNode({
				request: mockRequest,
				fetch: mockFetch,
				cookies: mockCookies
			} as Record<string, unknown>)) as Record<string, unknown>;
