...
<!-- Base edge -->
<BaseEdge {id} path={edgePath} style="stroke: var(--color-primary-500); stroke-width: 2;" />

<!-- Custom label positioned in the middle -->
{#if data?.label}
	<foreignObject x={labelX - 150} y={labelY - 12} width="300" height="30" style="z-index: 100;">
