...
{:else}
	<div
		class="relative border-l border-(--color-surface-200-800) bg-(--color-surface-100-900) flex flex-col {resizer.isResizing
			? ''
	...
	>
		...
		<button
			type="button"
			class="absolute top-2 -left-3 z-20 w-6 h-6 rounded-full bg-(--color-surface-100-900) border border-(--color-surface-300-700) flex items-center justify-center cursor-pointer transition-colors duration-150 hover:bg-(--color-surface-200-800)"
