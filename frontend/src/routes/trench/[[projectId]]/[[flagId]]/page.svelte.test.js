...
describe('Trench Page Component', () => {
  ...
  it('should handle map click in routing mode', async () => {
    ...
    const selectedConduitStore = vi.spyOn(vi.mocked('$lib/stores/store').selectedConduit, 'subscribe');
    ...
    const selectedProjectStore = vi.spyOn(vi.mocked('$lib/stores/store').selectedProject, 'subscribe');
    ...
    const routingToleranceStore = vi.spyOn(vi.mocked('$lib/stores/store').routingTolerance, 'subscribe');
