...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.RunSQL(
            """
            alter table conduit_type_color_mapping alter column uuid set default gen_random_uuid();
            """
        ),
        migrations.RunSQL(
            """
            alter table fiber_type alter column uuid set default gen_random_uuid();
            """
        ),
        migrations.RunSQL(
            """
