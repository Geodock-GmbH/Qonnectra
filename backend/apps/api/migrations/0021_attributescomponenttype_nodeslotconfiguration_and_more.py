...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "component_type",
                    models.TextField(
                        help_text="The type of the component (e.g. 'Router', 'Switch', 'Access Point', etc.)",
                        unique=True,
                ...
                (
                    ...
                    models.IntegerField(
                        default=1,
                        help_text="Number of slots occupied by the component (default: 1)",
                        verbose_name="Occupied Slots",
                    ),
                ),
                (
                    "manufacturer",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "side",
                    models.CharField(
                        help_text="The name of the side (e.g., 'A', 'B', 'Left Side', 'Right Side')",
                        max_length=50,
                        verbose_name="Side",
                    ),
                ),
                (
                    "total_slots",
                    models.IntegerField(
                        help_text="The total number of slots available on this side",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "port_alias",
                    models.TextField(
                        blank=True, null=True, verbose_name="Port In Alias"
                    ),
                ),
                (
                    "component_type",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        to="api.attributescomponenttype",
                        verbose_name="Component Type",
                    ),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slot_start",
                    models.IntegerField(
                        help_text="The start slot of the component in the node",
                        verbose_name="Slot Start",
                    ),
                ),
                (
                    "slot_end",
                    models.IntegerField(
                        help_text="The end slot of the component in the node",
                ...
                (
                    ...
                    models.IntegerField(
                        blank=True,
                        help_text="The number of the clip in the component",
                        null=True,
                        verbose_name="Clip Slot Number",
                    ),
                ),
                (
                    "purpose",
                    models.CharField(
                        ...
                        default="component",
                        help_text="The purpose of this slot range (component, reserve, or empty)",
                        max_length=20,
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="Optional label for this slot range (e.g., 'Reserve for future use')",
                        max_length=100,
                        null=True,
                        verbose_name="Label",
                    ),
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.CASCADE,
                        to="api.attributescomponentstructure",
                        verbose_name="Component Structure",
                    ),
                ),
                (
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        db_index=False,
                        help_text="The slot configuration (side) where this structure is placed",
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="structures",
                        to="api.nodeslotconfiguration",
            ...
            options={
                ...
                "indexes": [
                    ...
                    models.Index(
                        fields=["slot_configuration"],
                        name="idx_node_structure_slot_config",
                    ),
                    models.Index(
        ...
        migrations.AddConstraint(
            model_name="nodeslotconfiguration",
            constraint=models.UniqueConstraint(
                fields=("uuid_node", "side"), name="unique_node_slot_config_side"
            ),
        ),
        migrations.AddIndex(
