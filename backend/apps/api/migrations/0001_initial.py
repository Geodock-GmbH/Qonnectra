# Generated by Django 4.2.17 on 2025-02-21 22:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(db_column='company', db_index=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='executed_trenches', to='api.attributescompany', verbose_name='Company')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trench', models.ForeignKey(db_column='trench_uuid', db_index=False, on_delete=django.db.models.deletion.CASCADE, to='api.trench', verbose_name='Trench')),
            ],
            options={
                'verbose_name': 'Trench File',
                'verbose_name_plural': 'Trench Files',
        ...
        migrations.AddIndex(
            model_name='trenchfiles',
            index=models.Index(fields=['id_trench'], name='idx_trench_files_id_trench'),
        ),
        migrations.AddIndex(
            model_name='trench',
