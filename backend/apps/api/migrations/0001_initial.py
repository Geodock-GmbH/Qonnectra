# Generated by Django 4.2.17 on 2025-11-30 20:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('constructor', models.ForeignKey(blank=True, db_column='constructor', db_index=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='constructed_cables', to='api.attributescompany', verbose_name='Constructor')),
            ],
            options={
                'verbose_name': 'Cable',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mode', models.CharField(choices=[('AUTO', 'Automatic Organization')], default='AUTO', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_file', models.FileField(help_text='QGIS project file (.qgs or .qgz)', storage=apps.api.storage.QGISProjectStorage(), upload_to=apps.api.models.QGISProject.get_qgis_upload_path, verbose_name='QGIS Project File')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Microduct Cable Connection',
                'verbose_name_plural': 'Microduct Cable Connections',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('backend', 'Backend'), ('frontend', 'Frontend'), ('wfs', 'WFS (QGIS Server)')], db_index=True, default='backend', help_text='Whether this log came from backend or frontend', max_length=50, verbose_name='Source')),
                ...
                ('project', models.ForeignKey(blank=True, help_text='Project associated with this log entry (if applicable)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='logs', to='api.projects', verbose_name='Project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uuid_cable', models.ForeignKey(db_column='uuid_cable', db_index=False, help_text='The cable that the fiber belongs to', on_delete=django.db.models.deletion.CASCADE, to='api.cable', verbose_name='Cable')),
            ],
            options={
                'verbose_name': 'Fiber',
                'verbose_name_plural': 'Fibers',
                'db_table': 'fiber',
                'ordering': ['uuid_cable', 'fiber_number_absolute', 'bundle_number', 'fiber_number_in_bundle'],
            },
        ),
        migrations.CreateModel(
            name='FeatureFiles',
            fields=[
                ...
                ('file_path', models.FileField(max_length=500, storage=apps.api.storage.LocalMediaStorage(), upload_to=apps.api.models.FeatureFiles.get_upload_path, verbose_name='File Path')),
                ...
                ('content_type', models.ForeignKey(limit_choices_to={'app_label': 'api', 'model__in': ['trench', 'conduit', 'cable', 'node', 'address', 'residentialunit']}, on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype', verbose_name='Feature Type')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('layer', models.TextField(choices=[('inner', 'Inner'), ('outer', 'Outer')], default='inner', help_text='Inner or outer layer', verbose_name='Layer')),
        ...
        migrations.AddIndex(
            model_name='logentry',
            index=models.Index(fields=['-timestamp'], name='idx_log_entry_timestamp'),
        ),
        migrations.AddIndex(
            model_name='logentry',
            index=models.Index(fields=['level'], name='idx_log_entry_level'),
        ),
        migrations.AddIndex(
            model_name='logentry',
            index=models.Index(fields=['user'], name='idx_log_entry_user'),
        ),
        migrations.AddIndex(
            model_name='logentry',
            index=models.Index(fields=['source'], name='idx_log_entry_source'),
        ),
        migrations.AddIndex(
            model_name='logentry',
            index=models.Index(fields=['logger_name'], name='idx_log_entry_logger_name'),
        ),
        migrations.AddIndex(
            model_name='logentry',
        ...
        migrations.AddIndex(
            model_name='cablelabel',
            index=models.Index(fields=['cable'], name='idx_cable_label_cable'),
        ),
        migrations.AddIndex(
            model_name='cablelabel',
            index=models.Index(fields=['order'], name='idx_cable_label_order'),
        ),
        migrations.AddIndex(
            model_name='cable',
